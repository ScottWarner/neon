...
class ElasticSearchDataInserter extends DefaultTask{
    ...
    private void createCsvMapping(TransportClient client) {
        client.admin().indices()
            ...
            .startObject("firstname").field("type", "keyword").field("index", "false").endObject()
            .startObject("lastname").field("type", "keyword").field("index", "false").endObject()
            .startObject("city").field("type", "keyword").field("index", "false").endObject()
            .startObject("state").field("type", "keyword").field("index", "false").endObject()
            .startObject("salary").field("type", "long").field("index", "false").endObject()
            .startObject("hiredate").field("type", "date").field("format", "date_optional_time||E MMM dd HH:mm:ss zzz yyyy").field("index", "false").endObject()
...
//            .startObject("properties")
//            .startObject("value").field("type", "keyword").field("index", "false").endObject()
//            .endObject()
//            .endObject()
//            .endObject())
//            .execute().actionGet()
